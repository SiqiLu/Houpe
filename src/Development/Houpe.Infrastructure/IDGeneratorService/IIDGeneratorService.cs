...
public interface IIDGeneratorService
{
    ...
    /// </summary>
    public Guid BuildGuid(ulong a, ulong b) => ID.BuildGuid(a, b);

    /// <summary>
    ///     使用 <see cref="string" /> 生成 <see cref="System.Guid" />。
    /// </summary>
    public Guid BuildGuid(string input) => ID.BuildGuid(input);
    ...
    public string GuidShortCode() => ID.GuidShortCode();

    /// <summary>
    ///     根据 SQL Server 的排序规则生成的有时序的 Guid，先生成的 Guid 的排序一定靠前。
    /// </summary>
    public Guid NewSequentialGuid() => ID.NewSequentialGuid();
    ...
    public string NewSequentialId(string format = "t") => ID.NewSequentialId(format);

    /// <summary>
    ///     根据 SQL Server 的排序规则生成的有时序的 Guid.ToGuidString()，先生成的 Guid 的排序一定靠前。
    /// </summary>
    public static string NewId() => ID.NewId();
}
