...
namespace Houpe.Foundation
{
    ...
    public abstract class EnumClass : IEquatable<EnumClass>, IComparable<EnumClass>
    {
        ...
        public int CompareTo(EnumClass other) => other == null ? 1 : Code.CompareTo(other.Code);
    ...
    public class EnumClass<T> : EnumClass, IEquatable<EnumClass<T>>, IEquatable<T> where T : EnumClass<T>
    {
