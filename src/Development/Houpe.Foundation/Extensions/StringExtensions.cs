...
public static class StringExtensions
{
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static decimal AsDecimal(this string? s, decimal defaultValue = default) => !decimal.TryParse(s, out decimal result) ? defaultValue : result;
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static double AsDouble(this string? s, double defaultValue = default) => !double.TryParse(s, out double result) ? defaultValue : result;
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static float AsFloat(this string? s, float defaultValue = default) => !float.TryParse(s, out float result) ? defaultValue : result;
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static Guid AsGuid(this string? s, string format = "N", Guid? defaultValue = default) =>
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static int AsInt(this string? s, int defaultValue = default) => !int.TryParse(s, out int result) ? defaultValue : result;
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static short AsInt16(this string? s, short defaultValue = default) => !short.TryParse(s, out short result) ? defaultValue : result;
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static int AsInt32(this string? s, int defaultValue = default) => !int.TryParse(s, out int result) ? defaultValue : result;
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static long AsInt64(this string? s, long defaultValue = default) => !long.TryParse(s, out long result) ? defaultValue : result;
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static long AsLong(this string? s, long defaultValue = default) => !long.TryParse(s, out long result) ? defaultValue : result;
    ...
    /// <param name="defaultValue">如果 <paramref name="s" /> 为 <c>null</c> 或者转换失败，返回的默认值。</param>
    /// <returns>转换后的值。</returns>
    public static float AsSingle(this string? s, float defaultValue = default) => !float.TryParse(s, out float result) ? defaultValue : result;
    ...
    public static string SubString(this string s, int start, int count = 1)
    {
        ...
        return s.Length - count - start < 0 ? s[start..] : s.Substring(start, count);
    }
    ...
    /// </returns>
    public static string ToEmptyIfNull(this string? s) => s is null || s.IsNullOrEmpty() ? string.Empty : s;
    ...
    public static string ToMosaicString(this string s)
    {
        ...
        if (s.Length >= 12)
        {
            ...
            _ = (s.Length - 8).ToZeroIfNegNum().Times().Do(() => sb.Append('*'));
            _ = sb.Append(GetLast(s, 4));
        }
        else
        {
            _ = (s.Length - 4).ToZeroIfNegNum().Times().Do(() => sb.Append('*'));
            _ = sb.Append(GetLast(s, 4));
        }
    ...
    public static string? ToNullIfEmpty(this string? s) => s is null || s.IsNullOrEmpty() ? null : s;
