...
public class PasswordHasher_Should
{
    ...
    public void PasswordHasher_Options_Should()
    {
        ...
        PasswordHasherOptions options2 = new PasswordHasherOptions { IterationCount = 10000 };

        options2.AsDynamic()!.Rng = options1.AsDynamic()!.Rng;

        IPasswordHasher hasher1 = new PasswordHasher(options1);
        IPasswordHasher hasher2 = new PasswordHasher(options2);
        Randomizer r = new Randomizer();
    ...
    public void PasswordHasher_VerifyHashedPassword_DifferentIterationCount_Should()
    {
        ...
        IPasswordHasher hasher1 = new PasswordHasher(options1);
        IPasswordHasher hasher2 = new PasswordHasher(options2);
        IPasswordHasher hasher3 = new PasswordHasher(options3);
