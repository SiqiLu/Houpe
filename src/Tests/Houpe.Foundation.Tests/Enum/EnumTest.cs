...
public class EnumTest
{
    ...
    {
        // 任意值都比 null 值大
        Assert.IsTrue(TestEnumType.EDefault > null);
        Assert.IsTrue(TestEnumType.E1 > null);
        Assert.IsTrue(TestEnumType.E2 > null);
        ...
        // null test
        // ==
        Assert.IsTrue(null == (TestEnumType?)null);
        Assert.IsFalse(TestEnumType.EDefault == null);
        Assert.IsFalse(null == TestEnumType.EDefault);

        // !=
        Assert.IsFalse(null != (TestEnumType?)null);
        Assert.IsTrue(TestEnumType.EDefault != null);
        Assert.IsTrue(null != TestEnumType.EDefault);
    ...
    public void EnumTest_Equals_Should()
    {
        ...
        Assert.IsTrue(TestEnumType.Default?.Equals(TestEnumType.EDefault));

        Assert.IsFalse(TestEnumType.Default?.Equals((EnumClass<TestEnumType>?)null));
        Assert.IsFalse(TestEnumType.Default?.Equals(null));
